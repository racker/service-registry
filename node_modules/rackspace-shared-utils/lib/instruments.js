...
exports.measureWork = function(label, duration) {
  ...
  statsd.incrementTimer(label, duration);
};
 ...
 */
exports.setGauge = function(label, value) {
  gauges[label] = value;
  statsd.setGauge(label, value);
};
...
Work.prototype.stop = function(error) {
  ...
  if (error) {
    ...
    statsd.incrementCounter(this.label + '__error');
  } else {
    statsd.incrementTimer(this.label, delta);
  }
